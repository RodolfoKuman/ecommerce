...
<html>
    <head>
		...
		<style type="text/css">
			...
			*
			.odyContent div a:link, .bodyContent div a:visited, /* Yahoo! Mail Override */ .bodyContent div a .yshortcuts /* Yahoo! Mail Override */{
			/*editable*/ color:#336699;
				/*editable*/ font-weight:normal;
				/*editable*/ text-decoration:underline;
			}
			...
			*ip Set the styling for your email's data table links. Choose a color that helps them stand out from your text.
			*
			.daaTableContent a:link, .dataTableContent a:visited, /* Yahoo! Mail Override */ .dataTableContent a .yshortcuts /* Yahoo! Mail Override */{
				/*editable*/ color:#202020;
				/*editable*/ font-weight:bold;
				/*editable*/ text-decoration:underline;
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de pago en Librerias Shakespeare</h1>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy;Librerias Shakespaeare 2016 , All rights reserved.</em>
																<br />

																<strong>info@shakespearelibrerias.com</strong>
																<br />
